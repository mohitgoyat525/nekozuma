...
const Story = () => {
    ...
    <div className="container mx-auto mt-5">
      <h2 className="text-center fw-normal ff-franklin fs-xl">Story</h2>
      <p className="fw-normal max-w-4xl mx-auto text-xs text-center pt-3">
      ...
      <p className="fw-normal max-w-4xl mx-auto text-xs text-center pt-3xl">
        ...
        animated.
            ...
            <Image src='/assets/images/webp/cat-battles.webp' alt='cat-battle' width={1280} height={357} className='w-100 mt-5xl'/>
